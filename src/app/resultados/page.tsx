    ...
    <div className="min-h-screen bg-[#F8FAFC]">
          ...
          <div className="flex justify-between items-center">
            ...
            >
              ...
              <div className="text-left">
                <h1 className="text-white font-black text-2xl tracking-tighter">Rutas<span className="text-[#EA2264]">Ecuador</span>
                </h1>
      ...
      <footer className="bg-[#09184D] py-20 px-6 text-center">
        <div className="max-w-7xl mx-auto space-y-6">
          <h2 className="text-white font-black text-2xl tracking-tighter">Rutas<span className="text-[#EA2264]">Ecuador</span></h2>
